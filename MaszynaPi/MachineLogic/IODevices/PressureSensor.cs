...
namespace MaszynaPi.MachineLogic.IODevices 
{
    ...
    /// pressure data from <see cref="SenseHatDevice"/> sensor.
    /// </summary>
    class PressureSensor : IODevice 
    {
        ...
        /// <summary><see cref="SenseHatDevice"/> instance for communicating via python script processes with pressure sensor located on SenseHat module.</summary>
        readonly SenseHatDevice Sensor;

        /// <summary>Creates new instance of <see cref="PressureSensor"/> <see cref="IODevice"/>.</summary>
