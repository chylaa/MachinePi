...
type
  ...
  private
    ...
    function FuncRST(Index: Integer): TtkTokenKind;
    procedure IdentProc;
...
function TSynSampleSyn.FuncRST(Index: Integer): TtkTokenKind;
begin
  if IsCurrentToken(KeyWords[Index]) then
    Result := tkKey
  else
