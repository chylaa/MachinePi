...
namespace MaszynaPi
{
    ...
    /// Base on Gif Animation Creater code from https://github.com/DataDink/Bumpkit 
    /// </summary>
    public class GifWriter : IDisposable
    {
        ...
        /// <param name="Repeat">No of times the Gif should repeat... -1 not to repeat, 0 to repeat indefinitely (should be "infinitely"? MC 2024).</param>
        ...
        /// <summary>
        /// Overall bytesize of written to gif stream.
        /// </summary>
        ...
        public void WriteFrame(Image Image, int Delay = 0)
        {
            lock (_syncLock)
                using (var gifStream = new MemoryStream())
                {
                    ...
                    TotalByteSize += (ulong)gifStream.Length; 
